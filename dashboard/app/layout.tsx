...
export const metadata: Metadata = {
  title: "harmoni · Revenue Intelligence & Deal Protection",
  description:
    "Account-level fatigue scoring and next best action orchestration for B2B buying committees.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* BRAND.md: Google Fonts injection */}
